...
for (const expected of [
  ...
  'package/dist/common/project-encoding.d.ts',
  'package/dist/common/project-encoding.js',
  'package/dist/common/project-notifications.d.ts',
  'package/dist/common/project-semantics.d.ts',
  'package/dist/common/project-semantics.js',
  ...
  try {
    ...
    await writeFile(
      ...
      [
        ...
        "const controlError: ControlErrorCode = 'project.not-found'",
